...
const Cart = () => {
    ...
    const { cart, totalPrice} = context.state;
    const { reduceAmount, increaseAmount, removeProduct, calculateTotalPrice} = context;

    useMemo(() => calculateTotalPrice(),[calculateTotalPrice]);
